            ...
            <form method="post" action="send-password-reset.php" >
                ...
                <div class="parent_form">
                    ...
                    <div>
                        ...
                        <input type="email" id="recup_email" name="recup_email" placeholder="Email Adress"><br>
                    </div>

                    <input type="submit" value="Submit password reset request" name="recup_submit" id="recup_submit">
